...
<div id="header" style="position:fixed;">
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="hidden" name="category" value="banners"></td>
							</tr>
						</table>
					</center>
				</div>
			...
			if (isset($_POST['add']))
				{
					...
					$code = rand(0,100000000000);
								...
								else
								{
									...
									{
										move_uploaded_file($temp,"../templates/img/product/offers/".$name);
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>sale</h2></center></div>
			<br />
			...
			<table class="table table-hover" style="background-color:;">
				...
				<tr class="del<?php echo $id?>">
					<td><img class="img-polaroid" src = "../templates/img/product/offers/<?php echo $fetch['product_image']?>" height = "70px" width = "80px"></td>
