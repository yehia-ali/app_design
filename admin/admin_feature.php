...
if (isset($_POST['add']))
{
    ...
    else
    {
        ...
        else
        {
            ...
            move_uploaded_file($temp2,"../templates/img/product/feature/".$name2);
            move_uploaded_file($temp3,"../templates/img/product/feature/".$name3);
        ...
        <table class="table table-hover" style="background-color:;">
            ...
            while($fetch = $query->fetch_array())
            {
                ...
                <tr class="del<?php echo $id?>">
                    <td><img class="img-polaroid" src = "../templates/img/product/feature/<?php echo $fetch['product_image']?>" height = "30px" width = "30px">
                        <img class="img-polaroid" src = "../templates/img/product/feature/<?php echo $fetch['product_image2']?>" height = "30px" width = "30px">
                        <img class="img-polaroid" src = "../templates/img/product/feature/<?php echo $fetch['product_image3']?>" height = "30px" width = "30px"></td>
