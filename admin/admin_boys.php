...
<div id="header" style="position:fixed;">
	...
	<br>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="hidden" name="category" value="Boys"></td>
							</tr>
						</table>
					</center>
				</div>
		...
		<?php
			if (isset($_POST['add']))
				...
				header ("location:admin_boys.php");
			}}
		}
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>boys</h2></center></div>
			<br />
		...
		<div class="alert alert-info">
			<table class="table table-hover" style="background-color:;">
				...
				<tr class="del<?php echo $id?>">
					<td><img class="img-polaroid" src = "../templates/img/product/boys/<?php echo $fetch['product_image']?>" height = "70px" width = "80px"></td>
 ...
 $row = $result->fetch_array();
  ...
  echo "<script>window.location = 'admin_boys.php'</script>";
