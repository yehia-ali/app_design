        ...
        <form method="post" enctype="multipart/form-data">
            <center>
                <table>
                    ...
                    <tr>
                        <td><input type="hidden" name="category" value="boy"></td>
                    </tr>
                </table>
            </center>
    </div>
...
if (isset($_POST['add']))
{
    ...
    else
    {
        ...
        {
            move_uploaded_file($temp,"../templates/img/product/boy/".$name);
            move_uploaded_file($temp2,"../templates/img/product/boy/".$name2);
            move_uploaded_file($temp3,"../templates/img/product/boy/".$name3);
        ...
        <table class="table table-hover" style="background-color:;">
            ...
            while($fetch = $query->fetch_array())
            {
                ...
                <tr class="del<?php echo $id?>">
                    <td><img class="img-polaroid" src = "../templates/img/product/boy/<?php echo $fetch['product_image']?>" height = "30px" width = "30px">
                        <img class="img-polaroid" src = "../templates/img/product/boy/<?php echo $fetch['product_image2']?>" height = "30px" width = "30px">
                        <img class="img-polaroid" src = "../templates/img/product/boy/<?php echo $fetch['product_image3']?>" height = "30px" width = "30px"></td>
