...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="templates/img/favicon.png">
    <!-- Normalize CSS -->
                                                    ...
                                                    <div class="dropdown dropdown-lg">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right" role="menu">
                                                            <ul class="sidenav-nav">
                                                                <li><a href="#"><i class="flaticon-dress-1"></i>Girls</a></li>
                                                                <li><a href="#"><i class="flaticon-polo"></i>Boys</a></li>
                                        ...
                                        <li>
                                            <div class="additional-menu-area" id="additional-menu-area">
                                                <div id="mySidenav" class="sidenav">
                                                    ...
                                                    <ul class="sidenav-login-registration">
                                                        ...
                                                        <li data-toggle="collapse" data-target="#registration" class="collapsed">
                                                            ...
                                                            <div class="collapse" id="registration">
                                                                f<div class="login-registration-field">
                                                                    <form method="post">
                                                    ...
                                                    <ul class="sidenav-nav">
                                                        <li><a href="shop1.html"><i class="flaticon-dress-1"></i>Girls</a></li>
                                                        <li><a href="shop2.html"><i class="flaticon-polo"></i>Boys</a></li>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4">
                                ...
                                <div class="category-menu-area" id="category-menu-area">
                                    ...
                                    <ul class="category-menu-area-inner">
                                        <li><a href="shop1.html"><i class="flaticon-dress-1"></i>Girls<span><i class="flaticon-next"></i></span></a>
                                           
                                        </li>
                                        <li><a href="shop1.html"><i class="flaticon-polo"></i>Boys<span><i class="flaticon-next"></i></span></a>
                                       </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <td class="cart-form-heading">اسم المنتج</td>
                                        <td class="cart-form-heading">السعر</td>
                                        <td class="cart-form-heading">الكمية</td>
                                        <td class="cart-form-heading">المجموع</td>
                                        <td class="cart-form-heading"></td>
                                    </tr>
                                </thead>
...
<a ><img src=\"templates/img/product/'. $cat .'\" alt=\"cart\" class=\"img-responsive\">
</td>
<td>
<h3 required value='".$id."' name='pid[]'> ".$name."></h3>
</td>
...
<td class=\"dismiss\"><a href=\"#\"><i class=\"fa fa-times\" aria-hidden=\"true\"></i></a></td>
    ...
    ?>
                            ...
                            <div class="update-button">
                                <button class="btn-apply-coupon disabled" type="submit" value="Login">طلب</button>
                            </div>
                        </div>
                    </div>
                </div>
